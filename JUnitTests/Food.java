...
public class Food implements Comparable<Food> {
    ...
    public String evaluateComparison(Food other) {
        switch (compareTo(other)) {
            case -1: return this.getType() + " is less than " + other.type;
            case 1: return this.getType() + " is greater than " + other.type;
            default: return "Both are equal";
        }
    ...
    public static int caloriesOfFood(String type) {
        ...
        switch (type){
            ...
            case "Pear": return 57;
            case "Cookie": return 502;
            case "Grape": return 67;
            default: return  -1;
        }
